package com.radiohyrule.android.views;
...
public class AutoResizeTextView extends TextView {
    ...
    public static final float MIN_TEXT_SIZE_SP = 8;

    // Maximum text size for this text view
    public static final float MAX_TEXT_SIZE_SP = 22;
    ...
    private float mMaxTextSize = MAX_TEXT_SIZE_SP;

    // Lower bounds for text size
    private float mMinTextSize = MIN_TEXT_SIZE_SP;
    ...
    public void resizeText(int width, int height) {
        ...
        float lower = convertSPToPX(mMinTextSize);
        float upper = convertSPToPX(mMaxTextSize);
        int loop_counter=1;
    ...
    private float convertSPToPX(float size){
